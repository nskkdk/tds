...
hquantool=pink+'['+blue+'Hoàng Quân Tool'+pink+']'
hquantool_no_pro=pinkx+'[Hoàng Quân Tool]'+end
hln=pink+"["+blue+"Hoàng Quân Tool"+pink+"]"
def logo():
    log="""        \033[1;35m██████╗░░█████╗░░█████╗░███╗░░██╗
    \033[1;37m██╔══██╗██╔══██╗██╔══██╗████╗░██║
    \033[1;35m██║░░██║██║░░██║███████║██╔██╗██║
    \033[1;37m██║░░██║██║░░██║██╔══██║██║╚████║  
    \033[1;35m██████╔╝╚█████╔╝██║░░██║██║░╚███║
       \033[7;96m\033[1;96m Hoàng Quân Tool \033[0m \n               \033[4;40;96m\033[1;95m Tool ngon nhớ đang ký kênh nhé<33 \033[0m \n                        \033[4;40;95m\033[1;97m Z A L O  :  \033[1;96m0799119828 \033[0m \n              \033[7;96m\033[1;37m developer  :  hquantool \033[0m \n \n"""
    os.system('clear')
    for h in log:
       sys.stdout.write(h)
       sys.stdout.flush()
       sleep(0.001)
logo()
print(hquantool,'VUI LÒNG ĐỢI !',end='\r')
for dvt in range(3,0,-1):
        print(blue+'[Hoàng Quân Tool]',pink+'['+blue+str(dvt)+pink+']',end='\r')
        sleep(0.7)
logo()
while(True):
        token_tds=input(pink+'NHẬP'+blue+' ACCESS_TOKEN TDS: '+pink)
        ...
        if 'success' in ttacc.text:
                ...
                print(pink+'['+blue+'USER: '+pink+user.upper()+blue+']'+pink+'['+yellow+xu+' XU'+pink+']'+black+'['+xu_die+' XU DIE'+pink+']')
                sleep(1)
                break
logo()
while(True):
        while(True):
                while(True):
                        ck_fb=input(blue+'NHẬP'+pink+' COOKIE FACEBOOK: '+blue)
                        os.system("clear")
                        if ck_fb=='':break
